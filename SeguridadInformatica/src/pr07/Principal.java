...
public static  String alf="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 ,.:-()";


public static String[] mensaje_cifrado={"3O0ONvTNSVCtZZVPCNyNPNXXG0t7TGEA2T4EEDy,vE1YNDAVT5vAUQV",
...
public static String[] claves_cifrado={"CAJFN","ARhFNF","DAJR","hcR4ahFa09","ahFaYXY:b",
    "CAJFN","ARhFNF","DAJR","hcR4ahFa09","ahFaYXY:b"};

 

public static String alf2="aábcdeéfghiíjklmnñoópqrstuúvwxyzAÁBCDEÉFGHIÍJKLMNÑOÓPQRSTUÚVWXYZ0123456789 ,.:-()";


public static String[] mensaje_cifrado2={"ZKXLxpZFKÉFvOPÑOAAABLKYvVp5PryFÚMÑIFsp5vBOZCzvRPPpFNÍÉ",
...
public static String[] claves_cifrado2={"xvFB","JvÑfB","JBzvFÑfbÑ","1afBaV6","afBaUTU.á",
